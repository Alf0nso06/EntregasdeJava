...
public class Leerfichero {
	...
	public static void main(String[] args) {
		...
		System.out.println(LeerPalabras(" ","src/practica/lin_quijote.txt","Quijote"));
		System.out.println(Contiene("Quijote","src/practica/lin_quijote.txt"));
		System.out.println(ContarPalabrasUnicas("src/practica/lin_quijote.txt"));
		System.out.println(MediaDeLasLineas("src/practica/palabras_random.csv",","));
	}
}
